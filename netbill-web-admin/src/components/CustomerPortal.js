      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
         ...
         <div className="bg-white dark:bg-slate-800 p-10 rounded-[56px] shadow-2xl border border-slate-100 dark:border-slate-700 space-y-10 uppercase font-black">
            <div className="space-y-6">
               ...
               <div className="flex items-center space-x-5"><div className="w-14 h-14 bg-emerald-50 text-emerald-600 rounded-2xl flex items-center justify-center text-xl shadow-sm"><i className="fas fa-phone-alt"></i></div><div><p className="text-[9px] text-slate-400 tracking-[3px]">MOBILE NO</p><p className="text-xl font-black">{customer.mobile}</p></div></div>
               <div className="flex items-center space-x-5"><div className="w-14 h-14 bg-indigo-50 text-indigo-600 rounded-2xl flex items-center justify-center text-xl shadow-sm"><i className="fas fa-map-marker-alt"></i></div><div><p className="text-[9px] text-slate-400 tracking-[3px]">ZONE / AREA</p><p className="text-xl font-black">{customer.zone || 'Global'}</p></div></div>
               <div className="flex items-center space-x-5"><div className="w-14 h-14 bg-slate-50 text-slate-600 rounded-2xl flex items-center justify-center text-xl shadow-sm"><i className="fas fa-user-shield"></i></div><div><p className="text-[9px] text-slate-400 tracking-[3px]">PPPoE USER</p><p className="text-sm font-black">{customer.pppoeUsername}</p></div></div>
            </div>
